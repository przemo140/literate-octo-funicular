...
activities = {
    ...
    "Soccer Team": {
        "description": "Practice teamwork and improve soccer skills in competitive play",
        "schedule": "Tuesdays and Thursdays, 4:00 PM - 5:30 PM",
        "max_participants": 18,
        "participants": ["isabella@mergington.edu", "liam@mergington.edu"]
    },
    "Swimming Club": {
        "description": "Swimming drills, conditioning, and technique coaching",
    ...
    "Math Club": {
        "description": "Solve challenging math puzzles and prepare for academic contests",
